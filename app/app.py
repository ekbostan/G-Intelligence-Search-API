...
import requests
from utils import find_nearest_station, load_kml_data
...
def nearest_station():
    ...
    #     directions = get_walking_directions(location, nearest_station_geojson)
    #     nearest_station_geojson['properties']['directions'] = directions

    return jsonify(nearest_station_geojson)
